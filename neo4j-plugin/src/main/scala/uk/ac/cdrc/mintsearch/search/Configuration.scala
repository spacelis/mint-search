...
import uk.ac.cdrc.mintsearch.index.{BaseIndexManager, KeyValueNode, PropertyLabelNodeMarker}
...
/**
  ...
  */
trait ConfR2expPropLIdx extends PropertyLabelNodeMarker with KeyValueNode with NeighbourhoodByRadius with ExponentialPropagation with BaseIndexManager with NeighbourAwareContext {
