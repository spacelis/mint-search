...
class NessNodeSimilaritySpec extends WordSpec with Matchers {
  "NESSSimilarity" should {
    "do positive subtracting" in new NessNodeSimilarity with KeyValueNode {
    ...
    "handle empty" in new NessNodeSimilarity with KeyValueNode {
    ...
    "handle no intersection" in new NessNodeSimilarity with KeyValueNode {
